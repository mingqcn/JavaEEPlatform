...
public class ResponseUtil {
    ...
    public static Object retWithObj(ReturnNo code, String errmsg, Object data) {
    ...
    public static Object retWithObj(BusinessException e, Object data) {
        if (null != e) {
            return retWithObj(e.getErrno(), e.getMessage(), data);
        } else {
            return retWithObj(ReturnNo.OK, ReturnNo.OK.getMessage(), data);
        }
    }

    public static Object retWithObj(Object data) {
        return retWithObj(ReturnNo.OK, ReturnNo.OK.getMessage(), data);
    }
}
