...
import cn.edu.xmu.javaee.restfuldemo.util.JacksonUtil;
...
public class BindingResultGoodsControllerTest {
    ...
    public void createGoodTest() throws Exception {
        ...
        String responseString = this.mvc.perform(post("/bindingresult/goods").contentType("application/json;charset=UTF-8").content(goodJson))
